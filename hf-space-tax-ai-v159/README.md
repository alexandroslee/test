...
- Release ID: `tax-ai-1.5.9-nemotron-parse-20260831-r4`
...
V1.5.9 r4 therefore no longer requires one contiguous `54169882` token. It:
...
Document OCR can legitimately emit compatible CJK glyph variants such as `應税√`, `应税`, `零税率`, or `免税`. V1.5.9 normalizes only tax-label glyphs before rule evaluation:
